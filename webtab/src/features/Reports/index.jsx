...
function MetricCard({ label, value, accent = false }) {
  return (
    <div className={`bg-white border rounded-xl p-4 ${accent ? 'border-blue-200' : 'border-gray-200'}`}>
      <p className="text-xs text-gray-500 mb-1">{label}</p>
      <p className={`text-lg font-semibold ${accent ? 'text-blue-700' : 'text-gray-900'}`}>
...
export default function Reports() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      {/* Header */}
      <h1 className="text-lg font-semibold text-gray-900 mb-4">Period Report</h1>
      ...
      <div className="flex gap-3 mb-6">
        ...
        <button
          onClick={loadReport}
          disabled={loading}
          className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
      ...
      {report && s && (
        <>
          ...
          <div className="space-y-3">
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mt-4 mb-2">Salary</div>
            ...
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mt-4 mb-2">Social Insurance</div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mt-4 mb-2">Tax & Cost</div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
